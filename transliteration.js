...
function orthChoiceSimple (veld)
{
	...
	document.write ('  <option value="2">Etimologičny pravopis</option>');
...
{ 	iW = "%" + iW + "%";
	...
	iW = iW.replace (/ŕ/g,"ř"); 
	var aPos = iW.indexOf ("ř"); var vowel = /[aeiouyąęųåėȯèòěê]/;
	...
	{ iW = iW.substring (0, rPos) + "ṙ" + iW.substring (rPos + 1, iW.length); /* iW = iW.replace (/’ṙ/, "ṙ"); iW = iW.replace (/jṙ/, "ŕ"); */
	...
	if (flav == "4")
		...
		{ iW = iW.replace (/ć/g,"č"); iW = iW.replace (/đ/g,"dž"); 
		  iW = iW.replace (/ṱ/g,"t"); iW = iW.replace (/ḓ/g,"d");
		  iW = iW.replace (/[êė]/g,"e");
		  iW = iW.replace (/[åȯ]/g,"o");
		  iW = iW.replace (/ų/g,"u"); iW = iW.replace (/ŭ/g,"v");
		  iW = iW.replace (/([šžčcj])ę/g,"$1a"); iW = iW.replace (/ę/g,"ja");
		  iW = iW.replace (/([šžčcj])ě/g,"$1e"); 
		  iW = iW.replace (/([ŕṙ])%/g,"r%"); iW = iW.replace (/ṙ/g,"or"); iW = iW.replace (/ŕ/g,"er"); 
		...
		{ iW = iW.replace (/ų/g,"u"); iW = iW.replace (/ŭ/g,"v"); 
		  iW = iW.replace (/ľ/g,"l"); iW = iW.replace (/ř/g,"r"); iW = iW.replace (/ń/g,"n"); 
		  iW = iW.replace (/ť/g,"t"); iW = iW.replace (/ď/g,"d"); iW = iW.replace (/ś/g,"s"); iW = iW.replace (/ź/g,"z");
		  iW = iW.replace (/šč/g,"št"); 
		  iW = iW.replace (/[ṱḓ]/g,"");
		  iW = iW.replace (/å/g,"a");
		  iW = iW.replace (/[ęė]/g,"e"); iW = iW.replace (/ê/g,"ě");
		  iW = iW.replace (/y/g,"i"); 
		  iW = iW.replace (/ȯ%/g,"o%");
		  iW = iW.replace (/([šžčcj])ě/g,"$1e"); 
		  iW = iW.replace (/[`’]/g,"#%"); 
	...
	{	if (flav == "2")
		...
		{ iW = iW.replace (/ě/g,"ьe");
		  ...
		  iW = iW.replace (/l/g,"ł"); iW = iW.replace (/łe/g,"le"); iW = iW.replace (/łi/g,"l"); iW = iW.replace (/ii/g,"i"); 
		  iW = iW.replace (/łi/g,"l"); iW = iW.replace (/łЬ/g,"l"); */
	...
	/* Poljsky */
		...
		{ iW = jgedoe (iW, type);
		  ...
		  iW = iW.replace (/lь/g,"ĺ"); iW = iW.replace (/lЬ/g,"ĺ"); iW = iW.replace (/li/g,"ĺi"); iW = iW.replace (/rzь/g,"rz");
		  iW = iW.replace (/ь/g,"i");
		  iW = iW.replace (/Ь/g,"ь");
		  ...
		  iW = iW.replace (/v/g,"w");
		  iW = iW.replace (/h/g,"ch");
		  iW = iW.replace (/l/g,"ł"); iW = iW.replace (/ĺ/g,"l"); 
		  iW = iW.replace (/tь/g,"ť"); iW = iW.replace (/ti/g,"ti"); 
		  iW = iW.replace (/dь/g,"ď"); iW = iW.replace (/di/g,"di");
		  iW = iW.replace (/cь/g,"ć"); iW = iW.replace (/ci/g,"ci"); 
		  iW = iW.replace (/dzь/g,"dź"); iW = iW.replace (/dzi/g,"dzi");
		  iW = iW.replace (/sь/g,"ś");
		  iW = iW.replace (/zь/g,"ź");
		  ...
		  iW = iW.replace (/ya/g,"ja"); iW = iW.replace (/yą/g,"ją"); 
	...
	{ 
		...
		if (flav == "1")	{	iW = iW.replace (/ṙ/g,"ър"); iW = iW.replace (/ŕ/g,"ьр");
						iW = iW.replace (/ě/g,"Ê"); 
						iW = iW.replace (/[ḓṱ]/g,""); 
					}
		else			{	iW = iW.replace (/[ṙŕ]/g,"р"); 	
						iW = iW.replace (/ė/g,"е");
						if (flav == "J") 
						{ 	iW = iW.replace (/є/g,"е");
		...
		{	
			...
			if (flav == "1")	{ iW = iW.replace (/[йь]е/g,"ѥ");
						  iW = iW.replace (/[йь]и/g,"ӥ");
						  iW = iW.replace (/ш[чћ]/g,"щ");
						}
			else			{ iW = iW.replace (/([#%аеєиоуы])е/g,"$1э");
	...
	{	if (flav == "J") { iW = iW.replace (/[ŕṙ]/g,"r"); iW = iW.replace (/ȯ/g,"o"); iW = iW.replace (/ě/g,"e"); } else {
	...
	{	  iW = iW.replace (/nads([eę])/g,"nac$1");
		  ...
		  iW = iW.replace (/e/g,"ɛ"); 
		  iW = iW.replace (/ė/g,"ɜ");
		  iW = iW.replace (/ě/g,"ьɛ"); iW = iW.replace (/ę/g,"ьæ"); iW = iW.replace (/ŕ/g,"ьǝr");
		  ...
		  iW = iW.replace (/c/g,"t͡s"); iW = iW.replace (/č/g,"t͡ʃ"); 
		  iW = iW.replace (/šć/g,"ɕt͡ɕ"); iW = iW.replace (/ć/g,"t͡ɕ");
		  iW = iW.replace (/dz/g,"d͡z"); iW = iW.replace (/dž/g,"d͡ʒ"); 
		  iW = iW.replace (/žđ/g,"ʑd͡ʑ"); iW = iW.replace (/đ/g,"d͡ʑ");
		  iW = iW.replace (/x/g,"ks");
		  iW = iW.replace (/h/g,"x");
		  iW = iW.replace (/š/g,"ʃ");
		  iW = iW.replace (/ž/g,"ʒ");
		  ...
		  iW = iW.replace (/ť/g,"tʲ"); iW = iW.replace (/tь/g,"tʲ");
		  iW = iW.replace (/ď/g,"dʲ"); iW = iW.replace (/dь/g,"dʲ");
		  iW = iW.replace (/ś/g,"sʲ"); iW = iW.replace (/sь/g,"sʲ");
		  iW = iW.replace (/ź/g,"zʲ"); iW = iW.replace (/zь/g,"zʲ");
		  iW = iW.replace (/ř/g,"rʲ"); iW = iW.replace (/r[ьj]/g,"rʲ");
		  iW = iW.replace (/ń/g,"ɲ"); iW = iW.replace (/n[ьj]/g,"ɲ");
		  iW = iW.replace (/ľ/g,"ʎ"); iW = iW.replace (/l[ьj]/g,"ʎ"); 
		  iW = iW.replace (/ь/g,"j"); 
		  iW = iW.replace (/l/g,"ɫ"); iW = iW.replace (/ɫ([ii̯e])/g,"l$1"); 
		  iW = iW.replace (/t͡sj/g,"t͡sʲ"); iW = iW.replace (/d͡zj/g,"d͡zʲ");
	}
	...
	/* Albansky */
		...
		{ iW = iW.replace (/[ŕṙ]/g,"ër"); 
		  ...
		  iW = iW.replace (/ų/g,"u"); iW = iW.replace (/ę/g,"je"); 
		  iW = iW.replace (/ć/g,"q"); iW = iW.replace (/đ/g,"xh");
		  ...
		  iW = iW.replace (/le/g,"Ľe"); iW = iW.replace (/li/g,"Ľi"); iW = iW.replace (/lj/g,"Ľ");
		  iW = iW.replace (/l/g,"ll"); iW = iW.replace (/Ľ/g,"l");
		  iW = iW.replace (/y/g,"i");
		}
	...
	/* Armensky */
		...
		{ iW = jgedoe (iW, type); 
		  ...
		  iW = iW.replace (/šj/g,"š"); iW = iW.replace (/čj/g,"č"); 
		  iW = iW.replace (/žj/g,"ž"); iW = iW.replace (/jj/g,"j"); 
	...
	/* Gruzinsky */
		...
		{ iW = jgedoe (iW, type); 
		  ...
		  iW = iW.replace (/ṙ/g,"or"); iW = iW.replace (/ŕ/g,"or");  
		  iW = iW.replace (/[ěę]/g,"je");
		  iW = iW.replace (/ij/g,"i"); iW = iW.replace (/ji/g,"i"); iW = iW.replace (/Ь/g,""); 
		  iW = iW.replace (/[iyjь]/g,"ი"); iW = iW.replace (/იი/g,"ი"); 
	...
	/* Grečsky */
		...
		{ iW = iW.replace (/čt/g,"tzj"); iW = iW.replace (/ć/g,"č"); iW = iW.replace (/šč/g,"stzj");
		  ...
		  iW = iW.replace (/ṙ/g,"or"); iW = iW.replace (/ŕ/g,"er"); 
		  iW = iW.replace (/ę/g,"ě"); 
		  ...
		  iW = iW.replace (/ogo%/g,"ogω%"); iW = iW.replace (/ego%/g,"egω%"); iW = iW.replace (/%od/g,"%ωt"); 
		  iW = iW.replace (/%v`/g,"%vo"); iW = iW.replace (/%s`/g,"%so");
		  iW = iW.replace (/Ь/g,""); iW = iW.replace (/jь/g,"ь");
		  iW = iW.replace (/ija/g,"ьa"); iW = iW.replace (/ije/g,"ьe"); iW = iW.replace (/iji/g,"ьi");
		  iW = iW.replace (/ijo/g,"ьo"); iW = iW.replace (/iju/g,"ьu");
	...
	/* Vugorsky */
		...
		{ iW = iW.replace (/ć/g,"ť"); iW = iW.replace (/đ/g,"ď");
		  iW = jgedoe (iW, type);
		  iW = iW.replace (/a/g,"á"); iW = iW.replace (/å/g,"a"); 
		  iW = iW.replace (/[ěę]/g,"je"); iW = iW.replace (/ė/g,"e");
		  iW = iW.replace (/[ṙŕ]/g,"ör"); 
		  iW = iW.replace (/y/g,"ü"); 
		  iW = iW.replace (/[ȯ’]/g,"ö"); iW = iW.replace (/ų/g,"ú");
		  iW = iW.replace (/ć/g,"č"); iW = iW.replace (/dź/g,"dž");
		  iW = iW.replace (/šj/g,"š"); iW = iW.replace (/čj/g,"č"); 
		  iW = iW.replace (/žj/g,"ž"); iW = iW.replace (/jj/g,"j"); 

		  iW = iW.replace (/sЬ/g,"s"); iW = iW.replace (/zЬ/g,"z"); iW = iW.replace (/rЬ/g,"r");
		  iW = iW.replace (/[Ьь]/g,"j");
	...
	/* Latvijsky */
		...
		{ iW = iW.replace (/ć/g,"č"); iW = iW.replace (/đ/g,"dž");
		  ...
		  iW = iW.replace (/å/g,"a"); 
		  iW = iW.replace (/[ȯ’]/g,"o"); 
		  iW = iW.replace (/[ěę]/g,"ьē"); iW = iW.replace (/ė/g,"e");
		  iW = iW.replace (/i/g,"ьi"); iW = iW.replace (/y/g,"i");
		  iW = iW.replace (/ų/g,"ū"); 
		  iW = iW.replace (/šj/g,"š"); iW = iW.replace (/čj/g,"č"); 
		  iW = iW.replace (/žj/g,"ž"); iW = iW.replace (/jj/g,"j"); 
	...
	/* Rumunsky */
		...
		{ iW = jgedoe (iW, type);
		  ...
		  iW = iW.replace (/[ęė]/g,"e"); iW = iW.replace (/ų/g,"u"); 
		  iW = iW.replace (/ě/g,"je"); 
		  iW = iW.replace (/([čšžj])j/g,"$1"); 
		  iW = iW.replace (/čt/g,"št");
		  iW = iW.replace (/đ/g,"ǯ"); iW = iW.replace (/dž/g,"ǯ");
		  iW = iW.replace (/å/g,"a"); 
		  iW = iW.replace (/ć/g,"č"); 
		  iW = iW.replace (/[ȯ’]/g,"ă"); 
		  iW = iW.replace (/y/g,"î");
		  iW = iW.replace (/c/g,"ț"); 
		  iW = iW.replace (/k([aăou%])/g,"c$1"); iW = iW.replace (/k([eiî])/g,"ch$1"); iW = iW.replace (/k/g,"c"); 
		  iW = iW.replace (/cs/g,"x"); 
		  iW = iW.replace (/g([eiî])/g,"gh$1");
		  iW = iW.replace (/ča/g,"cea"); iW = iW.replace (/č([ăou%])/g,"ci$1"); iW = iW.replace (/č([eiî])/g,"c$1"); iW = iW.replace (/č/g,"ci"); 
		  iW = iW.replace (/ǯa/g,"gea"); iW = iW.replace (/ǯ([ăou%])/g,"gi$1"); iW = iW.replace (/ǯ([eiî])/g,"g$1"); 
		...
		{ iW = jgedoe (iW, type);
		  ...
		  iW = iW.replace (/[ȯ’]/g,"y"); 
		  iW = iW.replace (/([čšžj])j/g,"$1"); 
		  iW = iW.replace (/ć/g,"č"); iW = iW.replace (/čt/g,"č");
		  iW = iW.replace (/d[źž]/g,"ǯ");
		  iW = iW.replace (/c/g,"ts"); 
		  iW = iW.replace (/k/g,"c"); 
		  iW = iW.replace (/č([aeow])/g,"ti$1"); iW = iW.replace (/č/g,"ts");
		  iW = iW.replace (/ǯ([aeow])/g,"di$1"); iW = iW.replace (/ǯ/g,"dz");
		  iW = iW.replace (/š([aeow])/g,"si$1"); iW = iW.replace (/š/g,"s");
		  iW = iW.replace (/ž([aeow])/g,"zi$1"); iW = iW.replace (/ž/g,"z");
		  iW = iW.replace (/f/g,"ff"); 
		  iW = iW.replace (/vv/g,"vyv"); 
		  iW = iW.replace (/v/g,"f"); 
		  iW = iW.replace (/l([ьЬei])/g,"L$1"); iW = iW.replace (/l/g,"ll");  iW = iW.replace (/L/g,"l"); 
		  iW = iW.replace (/ьi/g,"i");
	...
	{
	 	iW = iW.replace (/å/g,"a"); 
		iW = iW.replace (/([jčšžćđ])e/g,"$1E"); iW = iW.replace (/[eė]/g,"ä"); iW = iW.replace (/E/g,"e"); 
		...
		iW = iW.replace (/ć/g,"č"); 
		iW = iW.replace (/dž/g,"ǧ"); iW = iW.replace (/đ/g,"ǧ");
		iW = iW.replace (/[’ı]/g,""); 
		iW = iW.replace (/nj/g,"ñ"); iW = iW.replace (/ń/g,"ñ"); iW = iW.replace (/n#j/g,"ñ"); 
	...
	{ 	iW = iW.replace (/ı/g,"i"); iW = iW.replace (/#/g,"");
		iW = jgedoe (iW, type); 
		
		iW = iW.replace(/tЬ/g,"ť"); iW = iW.replace(/tь/g,"ťj");
		iW = iW.replace(/dЬ/g,"ď"); iW = iW.replace(/dь/g,"ďj");
		iW = iW.replace(/rЬ/g,"r"); iW = iW.replace(/rь/g,"rj");
		iW = iW.replace(/lЬ/g,"lj"); iW = iW.replace(/lь/g,"lj");
		iW = iW.replace(/nЬ/g,"ň"); iW = iW.replace(/nь/g,"ň");
		iW = iW.replace(/sЬ/g,"s"); iW = iW.replace(/sь/g,"sj");
		iW = iW.replace(/zЬ/g,"z"); iW = iW.replace(/zь/g,"zj");
		iW = iW.replace(/Ь/g,""); iW = iW.replace(/ь/g,"j");

		iW = iW.replace(/[aå]/g,"ā");
		iW = iW.replace(/j[ěė]/g,"jē"); iW = iW.replace(/[ěė]/g,"jē");
	...
	iW = iW.replace (/jj/g,"j");
	iW = iW.replace (/[#ı%]/g,""); OrigW = OrigW.replace (/%/g,"");
...
function nmsify (iW)
{
	iW = iW.replace (/[яꙗ]/g,"#a"); iW = iW.replace (/ьа/g,"#a");
	iW = iW.replace (/ѥ/g,"#e"); iW = iW.replace (/ье/g,"#e");
	iW = iW.replace (/ї/g,"#i"); iW = iW.replace (/ьи/g,"#i");
	iW = iW.replace (/ё/g,"#o"); iW = iW.replace (/ьо/g,"#o");
	iW = iW.replace (/ю/g,"#u"); iW = iW.replace (/ьу/g,"#u");
	iW = iW.replace (/ѩ/g,"#ę"); iW = iW.replace (/ьѧ/g,"#ę");
	iW = iW.replace (/ѭ/g,"#ų"); iW = iW.replace (/ьѫ/g,"#ų");
	iW = iW.replace (/нь/g,"ń"); iW = iW.replace (/н#/g,"nj"); iW = iW.replace (/њ/g,"nj");
	iW = iW.replace (/ль/g,"ĺ"); iW = iW.replace (/л#/g,"lj"); iW = iW.replace (/љ/g,"lj");
	iW = iW.replace (/рь/g,"ŕ"); iW = iW.replace (/р#/g,"ŕ");
	iW = iW.replace (/ть/g,"ť"); iW = iW.replace (/т#/g,"ť");
	iW = iW.replace (/дь/g,"ď"); iW = iW.replace (/д#/g,"ď");
	iW = iW.replace (/сь/g,"ś"); iW = iW.replace (/с#/g,"ś");
	iW = iW.replace (/зь/g,"ź"); iW = iW.replace (/з#/g,"ź");
	iW = iW.replace (/ь%/g,"%");
	...
	iW = iW.replace (/s[xz]/g,"š"); iW = iW.replace (/c[xz]/g,"č"); iW = iW.replace (/z[xs]/g,"ž"); iW = iW.replace (/ż/g,"ž"); iW = iW.replace (/ye/g,"ě");

	iW = iW.replace (/qu/g,"kv"); iW = iW.replace (/ŀ/g,"ȯl"); iW = iW.replace (/[ăq`]/g,"’");
	iW = iW.replace (/ch/g,"h"); iW = iW.replace (/w/g,"v"); iW = iW.replace (/x/g,"ks");
	
	iW = iW.replace (/[áàâā]/g,"a"); iW = iW.replace (/[íìîīĭı]/g,"i"); iW = iW.replace (/[úûůū]/g,"u"); iW = iW.replace (/[ąǫũ]/g,"ų"); iW = iW.replace (/ù/g,"ŭ"); 
	iW = iW.replace (/[éē]/g,"e"); iW = iW.replace (/[ĕëè]/g,"ė");  
	iW = iW.replace (/œóô/g,"o"); iW = iW.replace (/[ŏöò]/g,"ȯ"); iW = iW.replace (/ý/g,"y"); 
	iW = iW.replace (/ł/g,"l"); iW = iW.replace (/ç/g,"c"); iW = iW.replace (/ʒ/g,"z"); iW = iW.replace (/ĵ/g,"j");
 	iW = iW.replace (/[ĺļǉ]/g,"ľ"); iW = iW.replace (/[ňñņǌ]/g,"ń"); iW = iW.replace (/ř/g,"ŕ"); iW = iW.replace (/t́/g,"ť"); iW = iW.replace (/d́/g,"ď"); 
	
	iW = iW.replace (/([jćđšžč])y/g,"$1i"); iW = iW.replace (/jj/g,"j");
